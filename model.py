...
class JOINT_TEXT_MODEL():
    ...
    def build_model(self):
        ...
        sent_classifier = Dense(5, activation='softmax', name='sent_classifier')(sequence_output)


        self.model = Model(inputs=inputs, outputs=[slot_classifier, sequence_classifier, sent_classifier], name=self.name)
